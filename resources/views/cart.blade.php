...
<div class="top-bar">
 ...
 <font >  @if (isset($name))
         Hello {{ $name }}    <a href="../public/logout">退出</a>
         @else
  @endif
 </font>  </font> </div>
    </div>
...
<div class="block">
  ...
  <div class="flowBox">
    <h6><span>商品列表</span></h6>
        <form  method="post" action="/proorder/insert">
             {{ csrf_field() }}
            ...
            <tr>
              ...
              <th bgcolor="#ffffff">操作</th>
                   ...
                   @foreach ($cart_product as $product)
                    <tr>
                        <td bgcolor="#ffffff" >{{ $product->id }}</td>
              <td bgcolor="#ffffff" align="center">
                    <a href="goods.php?id=62" target="_blank"><img src="images/201605/thumb_img/62_thumb_G_1462952557730.jpg" border="0" title="随身风扇" /></a><br />
                    <a href="goods.php?id=62" target="_blank" class="f6">随身风扇</a>
                                                                                    </td>
                            <td bgcolor="#ffffff"></td>
                                          <td align="right" bgcolor="#ffffff">￥23.88元</td>
                            <td align="right" bgcolor="#ffffff">￥19.90元</td>
              <td align="right" bgcolor="#ffffff">
                                <input type="text" name="goods_number[45]" id="goods_number_45" value="{{ $product->num }}" size="4" class="inputBg" style="text-align:center " onkeydown="showdiv(this)"/>
                              </td>
              <td align="right" bgcolor="#ffffff">￥19.90元</td>
              <td align="center" bgcolor="#ffffff">
                <a href="javascript:if (confirm('您确实要把该商品移出购物车吗？')) location.href='flow.php?step=drop_goods&amp;id=45'; " class="f6">删除</a>
                                <a href="javascript:if (confirm('您确实要把该商品移出购物车吗？')) location.href='flow.php?step=drop_to_collect&amp;id=45'; " class="f6">放入收藏夹</a>
                            </td>
              </tr>
               @endforeach
