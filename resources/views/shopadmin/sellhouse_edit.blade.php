...
<div class="tab-div">
    ...
    <div id="tabbody-div">
      ...
      <form enctype="multipart/form-data" action="/shopadmin/sellhouse/update" method="post" name="theForm" >
        {{ csrf_field() }}
        ...
        <table width="90%" id="general-table" align="center" class="gk-table">
          <tr>
            <td class="label">标题：</td>
                <td><input type="hidden" name="id" value="{{ $house['id'] }}" /><input type="text" name="title" value="{{ $house['title'] }}" style="float:left;color:;" size="30" />
           </td>
          </tr>
           <tr>
            <td class="label">手机：</td>
            <td><input type="text" name="mobile" value="{{ $house['mobile'] }}" size="20" /></td>
          </tr>
          
         <tr>
            <td class="label">联系人：</td>
            <td><input type="text" name="contacts" value="{{ $house['contacts'] }}" size="20" /></td>
          </tr>
          <tr>
            <td class="label">上传商品图片：</td>
            <td>
              <input type="file" name="goods_img" size="35" />
                              <img src="{{ $house['images'] }}" width="16">
