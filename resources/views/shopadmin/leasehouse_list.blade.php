...
<!--遮罩-->
<h1>
      <a href="/shopadmin/leasehouse/add" class="btn btn-right btn-add-goods">添加新商品</a>
 
  
    <span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1">&nbsp;&nbsp;>&nbsp;&nbsp;租房管理 </span>
...
<div class="form-div">
  <form action="/admin/leasehouse/search" name="searchForm" enctype="multipart/form-data" method="post">
           {{ csrf_field() }}
        <!-- 分类 -->
    商品分类
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('is_on_sale'); ">是否显示</a></th>
    ...
    <td>{{ $product['id'] }}</td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $product['title'] }}</span></td>
    <td><span onclick="listTable.edit(this, 'edit_goods_sn', 72)"><img height="35" src="{{ $product['images'] }}" /></span></td>
        
    
    <td align="center">
        @if ( $product['is_show'] === 1) <a href="/admin/leasehouseleasehouse/off_sale/{{ $product['id']  }}"> <img src="/storage/images/yes.svg" width="20" " />  </a> @endif   
           @if ( $product['is_show'] === 0)   <a href="/admin/product/on_sale/{{ $product['id']  }}"> <img src="/storage/images/no.svg" width="20" " />  </a>  @endif   
    ...
    <td align="center">
      <a href="/leasehouse/detail/{{ $product['id'] }}" target="_blank" title="查看">查看</a>
      <a href="/shopadmin/leasehouse/edit/{{ $product['id'] }}" title="编辑">编辑</a>
      <a href="/shopadmin/leasehouse/delete/{{ $product['id'] }}" title="删除">删除</a>
           </td>
  </tr>
    @endforeach
  </table>
