...
<!--遮罩-->
<h1>
      <a class="btn btn-right" href="goods.php?act=list">出售房产列表</a>
  
    <span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1">&nbsp;&nbsp;>&nbsp;&nbsp;发布出售二手房 </span>
...
<div class="tab-div">
    ...
    <div id="tabbody-div">
      ...
      <form enctype="multipart/form-data" action="/shopadmin/sellhouse/insert" method="post" name="theForm" >
        {{ csrf_field() }}
        ...
        <table width="90%" id="general-table" align="center" class="gk-table">
          <tr>
            ...
            <td><input type="text" name="title" value="" style="float:left;color;" size="30" />
           </td>
          </tr>
          <tr>
          ...
          <tr>
           ...
           <tr>
            ...
            <td><input type="text" name="mobile" value="" style="float:left;color;" size="30" />
           </td>
          </tr>
               <tr>
            <td class="label">联系人：</td>
            <td><input type="text" name="contacts" value="" style="float:left;color;" size="30" />
           </td>
          </tr>
        </table>
