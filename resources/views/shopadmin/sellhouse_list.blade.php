...
<!--遮罩-->
<h1>
      <a href="/shopadmin/sellhouse/add" class="btn btn-right btn-add-goods">添加新商品</a>
 
  
    <span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1">&nbsp;&nbsp;>&nbsp;&nbsp;出售房产管理 </span>
...
<div class="form-div">
  <form action="/admin/sellhouse/search" name="searchForm" enctype="multipart/form-data" method="post">
           {{ csrf_field() }}
        <!-- 分类 -->
    商品分类
...
<table cellpadding="3" cellspacing="1">
  <tr>
   ...
   <th><a href="javascript:listTable.sort('goods_id'); ">编号</a><img src="/storage/images/sort_desc.png"/></th>
    ...
    <td align="center">
        @if ( $product['is_show'] === 1) <a href="/admin/product/off_sale/{{ $product['id']  }}"> <img src="/storage/images/yes.svg" width="20" " />  </a> @endif   
    ...
    <td align="center">
      <a href="/sellhouse/detail/{{ $product['id'] }}" target="_blank" title="查看">查看</a>
      <a href="/shopadmin/sellhouse/edit/{{ $product['id'] }}" title="编辑">编辑</a>
      <a href="/shopadmin/sellhouse/real_del/{{ $product['id'] }}" title="删除">删除</a>
           </td>
  </tr>
    @endforeach
  </table>
