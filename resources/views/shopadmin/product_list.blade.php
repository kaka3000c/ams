...
<!--遮罩-->
<h1>
      <a href="/shopadmin/product/add" class="btn btn-right btn-add-goods">添加新商品</a>
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <td align="center">
        @if ( $product['is_on_sale'] === 1) <a href="/shopadmin/product/off_sale/{{ $product['pro_id']  }}"> <img src="/storage/images/yes.svg" width="20" " />  </a> @endif   
           @if ( $product['is_on_sale'] === 0)   <a href="/shopadmin/product/on_sale/{{ $product['pro_id']  }}"> <img src="/storage/images/no.svg" width="20" " />  </a>  @endif   
    ...
    <td align="center">
      ...
      <a href="/shopadmin/product/edit/{{ $product['pro_id'] }}" title="编辑">编辑</a>
      <a href="/shopadmin/product/delete/{{ $product['pro_id'] }}" title="回收站">回收站</a>
        <a href="/shopadmin/product/real_del/{{ $product['pro_id'] }}" title="彻底删除">彻底删除</a>
           </td>
  </tr>
    @endforeach
  </table>
