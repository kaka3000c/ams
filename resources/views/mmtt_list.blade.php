...
<div class="bar-left">
 ...
 <div class="notice">
  ...
  <div class="indexpage">
      ...
      <div class="goods-title">茂名头条</div>
...
<div class="all_ms">
   @foreach ($article_list as  $article)
    <a class="goodsItem" href="/article/detail/{{ $article['article_id'] }}"> 
       
        <div  class="img-box">
            <div class ="pic">
                 <img src="{{$article['image'] }}"  class="goodsimg" width="180" height="180">
            </div>
            <div class="goods-brief">
                 <div class="gos-title">{{ $article['title'] }}
