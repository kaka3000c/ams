...
<!--遮罩-->
<h1>
      <a href="goods.php?act=add" class="btn btn-right btn-add-goods">添加供货商</a>
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('goods_name'); ">供应商名称</a></th>
     <th><a href="javascript:listTable.sort('goods_name'); ">供应商内容</a></th>
    <th><a href="javascript:listTable.sort('goods_name'); ">ischeck</a></th>
    ...
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $supplier->suppliers_name }}</span></td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $supplier->suppliers_desc }}</span></td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $supplier->is_check }}</span></td>
