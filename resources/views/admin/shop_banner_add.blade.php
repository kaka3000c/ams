...
<!--遮罩-->
<h1>
      <a class="btn btn-right" href="ads.php?act=list">广告列表</a>
  
    <span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1">&nbsp;&nbsp;>&nbsp;&nbsp;添加商家店铺banner </span>
  <div style="clear:both"></div>
</h1><script type="text/javascript" src="../js/calendar.php?lang=zh_cn"></script>
<link href="../js/calendar/calendar.css" rel="stylesheet" type="text/css" />
<div class="main-div">
<form action="/admin/shopbanner/insert" method="post" name="theForm" enctype="multipart/form-data" >
    {{ csrf_field() }}
  <table width="100%" id="general-table">
    ...
    <tr>
      ...
      <td>
        <input name="start_time" type="text" id="start_time" size="22" value='2018-12-21' readonly="readonly" /><button name="selbtn1" type="button" id="selbtn1" onclick="return showCalendar('start_time', '%Y-%m-%d', false, false, 'selbtn1');" class="cal"><img src="images/cal.png" alt=""></button>
      </td>
    </tr>
    <tr>
      <td class="label">结束日期</td>
      <td>
        <input name="end_time" type="text" id="end_time" size="22" value='2019-01-20' readonly="readonly"><button name="selbtn2" type="button" id="selbtn2" onclick="return showCalendar('end_time', '%Y-%m-%d', false, false, 'selbtn2');" class="cal"><img src="images/cal.png" alt=""></button>
      </td>
    </tr>
      <tbody id="0">
    <tr>
