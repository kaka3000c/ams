...
<!--遮罩-->
<h1>
      <a href="/admin/vote/add" class="btn btn-right btn-add-goods">添加投票</a>
  
  
    <span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1">&nbsp;&nbsp;>&nbsp;&nbsp; 在线投票列表 </span>
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <td>{{ $vote['vote_id'] }}</td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $vote['vote_name'] }}</span></td>
  
    <td align="center">
      <a href="/admin/vote/option_add/{{ $vote['vote_id'] }}" title="调查选项">调查选项</a>
      <a href="/admin/vote/edit/{{ $vote['vote_id'] }}" target="_blank" title="编辑">编辑</a>
      <a href="/admin/vote/delete/{{ $vote['vote_id'] }}" target="_blank" title="删除">删除</a>
