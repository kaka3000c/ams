...
<!--遮罩-->
<h1>
      <a href="/admin/friendlink/add" class="btn btn-right btn-add-goods">添加友情链接</a>
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    @foreach ($friendlink_list as $friendlink)
    <tr>
    <td><input type="checkbox" name="checkboxes[]" value="72"></td>
    <td>{{ $friendlink['link_id'] }}</td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $friendlink['link_name'] }}</span></td>
    <td><img height="35" src="{{ $friendlink['link_logo'] }}" /></span></td>
      
       <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $friendlink['link_url'] }}</span></td>
          <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $friendlink['show_order'] }}</span></td>
      
      
    <td align="center">
    <a href="/admin/friendlink/edit/{{ $friendlink['link_id'] }}" target="_blank" title="编辑">编辑</a>
      <a href="/admin/friendlink/delete/{{ $friendlink['link_id'] }}" target="_blank" title="删除">删除</a>
  </tr>
    @endforeach
  </table>
<!-- end goods list -->
