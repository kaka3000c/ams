...
<div class="tab-div">
  ...
  <div id="tabbody-div">
    <form  action="/admin/employ/update" method="post" enctype="multipart/form-data" name="theForm" onsubmit="return validate();">
    {{ csrf_field() }}
      ...
      <tr>
        ...
        <td>
            ...
            <input type="text" name="title" size ="40" maxlength="60" value="{{ $employ['title'] }}" /><span class="require-field">*</span></td>
      </tr>          
     
      <tr>
        <td class="narrow-label">是否显示</td>
        <td>
        <input type="radio" name="is_show" value="1"   @if ( $employ['is_show'] === 1) checked @endif  > 显示    
            <input type="radio" name="is_show" value="0"  @if ( $employ['is_show'] === 0) checked @endif  > 不显示
       ...
       <tr>
        ...
        <td><input type="text" name="source" maxlength="60" value="{{$employ['source']}}" /></td>
      </tr>
