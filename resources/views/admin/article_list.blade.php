...
<!--遮罩-->
<h1>
      <a href="/admin/article/add" class="btn btn-right btn-add-goods">添加新文章</a>
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <td class="first-cell" style="">{{ $article['cat_id'] }}</td>
    ...
    <td class="first-cell" style="">{{ $article['author'] }}</td>
    
    <td align="center">
       <a href="/article/detail/{{ $article['article_id'] }}" target="_blank" title="查看">查看</a>
       <a href="/admin/article/edit/{{ $article['article_id'] }}" title="编辑">编辑</a>
       <a href="/admin/article/delete/{{ $article['article_id'] }}" title="回收站">回收站</a>  
