...
<div class="tab-div">
  ...
  <div id="tabbody-div">
    <form  action="/admin/article/insert" method="post" enctype="multipart/form-data" name="theForm" onsubmit="return validate();">
    {{ csrf_field() }}
            <table width="90%" id="general-table">
      <tr>
        <td class="narrow-label">文章标题</td>
        <td><input type="text" name="title" size ="40" maxlength="60" value="" /><span class="require-field">*</span></td>
      </tr>          
      <!--  -->
      <tr>
