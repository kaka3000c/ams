...
<!--遮罩-->
<h1>
      <a class="btn btn-right" href="/admin/brand">商品品牌</a>
...
<form method="post" action="/admin/brand/insert" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
 {{ csrf_field() }}
...
<div id="footer">
共执行 2 个查询，用时 0.022796 秒，Gzip 已禁用，内存占用 1.516 MB<br />
