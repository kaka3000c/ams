...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('goods_number'); ">阅读量</a></th>
        <th><a href="javascript:listTable.sort('goods_number'); ">库存</a></th>
        <th><a href="javascript:listTable.sort('virtual_sales'); ">发布时间</a></th>
    <th>操作</th>
  </tr>
    ...
    <td align="center">
        @if ( $product['is_on_sale'] === 1) <a href="/admin/product/off_sale/{{ $product['pro_id']  }}"> <img src="/storage/images/yes.png" width="20" " />  </a> @endif   
           @if ( $product['is_on_sale'] === 0)   <a href="/admin/product/on_sale/{{ $product['pro_id']  }}"> <img src="/storage/images/no.png" width="20" " />  </a>  @endif   
    
    </td>
    
     <td align="center">
        @if ( $product['is_best'] === 1) <a href="/admin/product/off_sale/{{ $product['pro_id']  }}"> <img src="/storage/images/yes.png" width="20" " />  </a> @endif   
           @if ( $product['is_best'] === 0)   <a href="/admin/product/on_sale/{{ $product['pro_id']  }}"> <img src="/storage/images/no.png" width="20" " />  </a>  @endif   
    
    </td>
     <td align="center">
        @if ( $product['is_new'] === 1) <a href="/admin/product/off_sale/{{ $product['pro_id']  }}"> <img src="/storage/images/yes.png" width="20" " />  </a> @endif   
           @if ( $product['is_new'] === 0)   <a href="/admin/product/on_sale/{{ $product['pro_id']  }}"> <img src="/storage/images/no.png" width="20" " />  </a>  @endif   
    
    </td>
     <td align="center">
        @if ( $product['is_hot'] === 1) <a href="/admin/product/off_sale/{{ $product['pro_id']  }}"> <img src="/storage/images/yes.png" width="20" " />  </a> @endif   
           @if ( $product['is_hot'] === 0)   <a href="/admin/product/on_sale/{{ $product['pro_id']  }}"> <img src="/storage/images/no.png" width="20" " />  </a>  @endif   
    
    </td>
        <td align="right"><span onclick="listTable.edit(this, 'edit_goods_number', 72)">{{ $product['read_volume'] }}</span></td>
        <td align="right"><span onclick="listTable.edit(this, 'edit_goods_number', 72)">{{ $product['goods_number'] }}</span></td>
        <td align="center"><span onclick="listTable.edit(this, 'edit_virtual_sales', 72)">{{ $product['created_at'] }}</span></td>
    <td align="center">
