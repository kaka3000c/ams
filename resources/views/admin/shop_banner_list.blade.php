...
<!--遮罩-->
<h1>
      <a href="/admin/shopbanner/add" class="btn btn-right btn-add-goods">添加广告</a>
  
  
    <span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1">&nbsp;&nbsp;>&nbsp;&nbsp; 商家店铺广告列表 </span>
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('goods_name'); ">广告名称</a></th>
    <th><a href="javascript:listTable.sort('goods_sn'); ">图片</a></th>
    <th><a href="javascript:listTable.sort('shop_price'); ">广告详情</a></th>
    ...
    <td>{{ $banner['shop_banner_id'] }}</td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $banner['name'] }}</span></td>
    <td><img height="35" src="{{ $banner['image'] }}" /></span></td>
      <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $banner['content'] }}</span></td>
                       <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">
            @if ( $banner['enabled'] === 1) <a href="/admin/banner/off_enable/{{ $banner['shop_banner_id']  }}"> <img src="/storage/images/yes.svg" width="20" " />  </a> @endif   
           @if ( $banner['enabled'] === 0)   <a href="/admin/banner/on_enable/{{ $banner['shop_banner_id']  }}"> <img src="/storage/images/no.svg" width="20" " />  </a>  @endif   
    
                                   </span></td>
       <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $banner['start_time'] }}</span></td>
          <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $banner['end_time'] }}</span></td>
      
        <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $banner['created_at'] }}</span></td>
          <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $banner['updated_at'] }}</span></td>
      
    <td align="center">
    <a href="/admin/shopbanner/edit/{{ $banner['shop_banner_id'] }}" target="_blank" title="编辑">编辑</a>
      <a href="/admin/shopbanner/delete/{{ $banner['shop_banner_id'] }}" target="_blank" title="删除">删除</a>
  </tr>
    @endforeach
  </table>
<!-- end goods list -->
