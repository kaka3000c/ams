...
<!--遮罩-->
<h1>
      <a href="/admin/employ/add" class="btn btn-right btn-add-goods">添加招聘信息</a>
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('goods_name'); ">类型</a></th>
    
    <th><a href="javascript:listTable.sort('goods_name'); ">来源</a></th>
    <th><a href="javascript:listTable.sort('goods_name'); ">作者</a></th>
     <th><a href="javascript:listTable.sort('goods_name'); ">发布时间</a></th>
    <th><a href="javascript:listTable.sort('goods_name'); ">阅读量</a></th>
    <th><a href="javascript:listTable.sort('goods_name'); ">最初阅读量</a></th>
     <th><a href="javascript:listTable.sort('goods_name'); ">真实阅读量</a></th>
    ...
    <td class="first-cell" style="">{{ $article['title'] }}</td>
    <td class="first-cell" style=""></td>
    <td class="first-cell" style="">{{ $article['source'] }}</td>
              <td class="first-cell" style="">{{ $article['created_at'] }}</td>
     <td class="first-cell" style="">{{ $article['read_volume'] }}</td>
     <td class="first-cell" style="">{{ $article['initial_read_volume'] }}</td>
     <td class="first-cell" style="">{{ $article['volume'] }}</td>
    <td align="center">
       <a href="/employ/detail/{{ $article['id'] }}" target="_blank" title="查看">查看</a>
       <a href="/admin/employ/edit/{{ $article['id'] }}" title="编辑">编辑</a>
       <a href="/admin/employ/real_del/{{ $article['id'] }}" title="删除">删除</a>  
