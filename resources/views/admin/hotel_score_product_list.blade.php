...
<!--遮罩-->
<h1>
      <a href="/admin/hotel_score_product/add" class="btn btn-right btn-add-goods">添加新商品</a>
 
  
    <span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1">&nbsp;&nbsp;>&nbsp;&nbsp;饭店积分商品列表 </span>
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('shop_price'); ">兑换积分</a></th>
    ...
    <td><span onclick="listTable.edit(this, 'edit_goods_sn', 72)"><img height="35" src="{{ $product['image'] }}" /></span></td>
          <td align="right"><span onclick="listTable.edit(this, 'edit_goods_price', 72)">{{ $product['exchange_points'] }}</span></td>
    ...
    <td align="center">
      <a href="/hotel_score_product/detail/{{ $product['pro_id'] }}" target="_blank" title="查看">查看</a>
      <a href="/admin/hotel_score_product/edit/{{ $product['pro_id'] }}" title="编辑">编辑</a>
      <a href="/admin/hotel_score_product/delete/{{ $product['pro_id'] }}" title="回收站">回收站</a>
           </td>
  </tr>
    @endforeach
  </table>
