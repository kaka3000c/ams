...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('shop_price'); ">状态</a></th>
    ...
    @foreach ($hotel_order_list as $hotel_order)
    <tr>
    ...
    <td><img height="35" src="{{ $hotel_order['image'] }}" /></span></td>
    <td>
       @if ( $hotel_order['order_status'] === 0) <div style="float:left;">  待付款  </div>    @endif  
           @if ( $hotel_order['order_status'] === 1) <div style="float:left;">  待发货  <a>发货<a/></div>    @endif  
           @if ( $hotel_order['order_status'] === 2) <div style="float:left;">  配送中 </div>    @endif  
           @if ( $hotel_order['order_status'] === 3) <div style="float:left;">  已完成  </div>    @endif  
            @if ( $hotel_order['order_status'] === 4) <div style="float:left;">   <a>同意退货</a><a>不同意退货</a></div>    @endif     
            @if ( $hotel_order['order_status'] === 5) <div style="float:left;">  同意退货  </div>    @endif 
            @if ( $hotel_order['order_status'] === 6) <div style="float:left;">  不同意退货  </div>    @endif 
            @if ( $hotel_order['order_status'] === 7) <div style="float:left;">  退货完成  </div>    @endif 
