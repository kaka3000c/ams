...
<!--遮罩-->
<h1>
      <a href="/admin/adposition/add" class="btn btn-right btn-add-goods">添加广告位</a>
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('goods_id'); ">编号</a></th>
    <th><a href="javascript:listTable.sort('goods_name'); ">广告位名称</a></th>
    <th><a href="javascript:listTable.sort('goods_name'); ">广告位描述</a></th>
    <th><a href="javascript:listTable.sort('goods_name'); ">宽度</a></th>
    <th><a href="javascript:listTable.sort('goods_name'); ">高度</a></th>
    <th>操作</th>
  </tr>
    @foreach ( $adposition_list as $adposition )
    <tr>
    <td><input type="checkbox" name="checkboxes[]" value="72"></td>
    <td>{{ $adposition->position_id }}</td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $adposition->position_name }}</span></td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $adposition->position_desc }}</span></td>
      <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $adposition->ad_width }}</span></td>
     <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $adposition->ad_height }}</span></td>
   
    <td align="center">
      <a href="../goods.php?id=72" target="_blank" title="查看">查看</a>
      <a href="goods.php?act=edit&goods_id=72&extension_code=" title="编辑">编辑</a>
      <a href="goods.php?act=copy&goods_id=72&extension_code=" title="复制">移除</a>
