...
<div class="main-div">
<form action="/admin/shopbanner/update" method="post" name="theForm" enctype="multipart/form-data" >
    {{ csrf_field() }}
  <table width="100%" id="general-table">
    <tr>
      <td  class="label">
        广告名称</td>
      <td>
        <input type="hidden" name="shop_banner_id" value="{{$banner['shop_banner_id']}}" size="35" />
        <input type="text" name="name" value="{{$banner['name']}}" size="35" />
    ...
    <tr>
      <tr>
      <td  class="label">已存在的广告图片</td>
      <td>
          @if ( $banner['image'])<img src="{{$banner['image']}}" width="50"   />@endif   
           @if ( !$banner['image'])广告图片没有上传  @endif   
      </td>
    </tr>
    <tr>    
      <td  class="label">
  ...
  <tr>
      ...
      <td>
        <input type="text" name="ad_link" value="{{$banner['ad_link']}}" size="35" />
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <input type="text" name="content" value="{{$banner['content']}}" size="35" />
      </td>
    </tr>
