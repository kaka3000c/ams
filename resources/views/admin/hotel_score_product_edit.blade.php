...
</h1><script type="text/javascript" src="../js/utils.js"></script><script type="text/javascript" src="js/selectzone.js"></script><script type="text/javascript" src="js/colorselector.js"></script><script type="text/javascript" src="../js/calendar.php?lang="></script>
...
<div class="tab-div">
    ...
    <div id="tabbody-div">
      ...
      <form enctype="multipart/form-data" action="/admin/product/update" method="post" name="theForm" >
        {{ csrf_field() }}
        ...
        <table width="90%" id="general-table" align="center" class="gk-table">
          <tr>
            <td class="label">商品名称：</td>
                <td><input type="hidden" name="pro_id" value="{{ $product['pro_id'] }}" /><input type="text" name="goods_name" value="{{ $product['goods_name'] }}" style="float:left;color:;" size="30" />
           </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><select name="brand_id" onchange="hideBrandDiv()" ><option value="0">请选择...<option value="1">格力</option></select>
               
                           </td>
          </tr>
                   <tr>
            <td class="label">本店售价：</td>
            <td><input type="text" name="shop_price" value="{{ $product['shop_price'] }}" size="20" />
            </td>
          </tr>
           
          <tr>
            <td class="label">市场售价：</td>
            <td><input type="text" name="market_price" value="{{ $product['market_price'] }}" size="20" />
              
            </td>
          </tr>
          <tr>
            <td class="label">虚拟销量：</td>
            <td><input type="text" name="virtual_sales" value="{{ $product['virtual_sales'] }}" size="20" />
            </td>
          </tr>
          <tr>
            <td class="label">赠送消费积分数：</td>
            <td><input type="text" name="give_integral" value="{{ $product['give_integral'] }}" size="20" />
            <br /><span class="notice-span" style="display:block"  id="giveIntegral">购买该商品时赠送消费积分数,-1表示按商品价格赠送</span></td>
          </tr>
          <tr>
            <td class="label"> 赠送等级积分数：</td>
            <td><input type="text" name="rank_integral" value="{{ $product['rank_integral'] }}" size="20" />
            <br /><span class="notice-span" style="display:block"  id="rankIntegral">购买该商品时赠送等级积分数,-1表示按商品价格赠送</span></td>
          </tr>
          <tr>
            <td class="label"> 积分购买金额：</td>
          ...
          <tr id="promote_4">
            ...
            <td id="promote_6" class="cal-group">
              <input name="promote_start_date" type="text" id="promote_start_date" size="12" value='{{ $product['promote_start_date'] }}' readonly="readonly"><button type="button" class="cal" name="selbtn1" id="selbtn1" onclick="return showCalendar('promote_start_date', '%Y-%m-%d', false, false, 'selbtn1');"><img src="images/cal.png" alt=""></button> - <input name="promote_end_date" type="text" id="promote_end_date" size="12" value='{{ $product['promote_end_date'] }}' readonly="readonly" /><button type="button" class="cal" name="selbtn2" id="selbtn2" onclick="return showCalendar('promote_end_date', '%Y-%m-%d', false, false, 'selbtn2');"><img src="images/cal.png" alt=""></button>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <input type="file" name="goods_img" size="35" />
                              <img src="{{ $product['goods_img'] }}" width="16">
          ...
          <tr id="auto_thumb_1">
            ...
            <td id="auto_thumb_3">
              <input type="file" name="goods_thumb" size="35" />
                              <img src="{{ $product['goods_thumb'] }}" width="16">
        ...
        <table width="90%" id="mix-table" align="center">
            ...
            <td><input type="text" name="goods_weight" value="{{ $product['goods_weight'] }}" size="20" /> <select name="weight_unit"><option value="1" selected>千克</option><option value="0.001">克</option></select></td>
          </tr>
                              <tr>
            <td class="label"> 商品库存数量：</td>
<!--            <td><input type="text" name="goods_number" value="1" size="20"  /><br />-->
            <td><input type="text" name="goods_number" value="{{ $product['goods_number'] }}" size="20" /><br />
          ...
          <tr>
            ...
            <td><input type="text" name="warn_number" value="{{ $product['warn_number'] }}" size="20" /></td>
          </tr>
                    <tr>
            <td class="label">加入推荐：</td>
            <td><input type="checkbox" name="is_best" value="{{ $product['is_best'] }}"  />精品 <input type="checkbox" name="is_new" value="{{ $product['is_new'] }}"  />新品 <input type="checkbox" name="is_hot" value="{{ $product['is_hot'] }}"  />热销</td>
          </tr>
               <tr>
            <td class="label">加入销售：</td>
            <td>
                
                @if ( $product['is_sale'] == 1) <input type="checkbox" name="is_sale"  checked="checked" /> @endif   
                
                @if ( $product['is_sale'] == 0) <input type="checkbox" name="is_sale"   />   @endif  
               
                
                
                打勾表示允加入销售，否则不允许加入销售</td>
          </tr>
          <tr id="alone_sale_1">
            <td class="label" id="alone_sale_2">上架：</td>
            <td id="alone_sale_3"><input type="checkbox" name="is_on_sale" value="{{ $product['is_on_sale'] }}" checked="checked" /> 打勾表示允许销售，否则不允许销售。</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="keywords" value="{{ $product['keywords'] }}" size="40" /> 用空格分隔</td>
          </tr>
          <tr>
            <td class="label">商品简单描述：</td>
            <td><textarea name="goods_brief" cols="40" rows="3">{{ $product['goods_brief'] }}</textarea></td>
          </tr>
          <tr>
            <td class="label">
             商家备注： </td>
            <td><textarea name="seller_note" cols="40" rows="3">{{ $product['seller_note'] }}</textarea><br />
...
<div id="footer">
共执行 10 个查询，用时 0.083587 秒，Gzip 已禁用，内存占用 1.957 MB<br />
