...
<!--遮罩-->
<h1>
      <a class="btn btn-right" href="ads.php?act=list">饭店门店列表</a>
  
    <span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1">&nbsp;&nbsp;>&nbsp;&nbsp;添加饭店门店 </span>
  <div style="clear:both"></div>
</h1><script type="text/javascript" src="../js/calendar.php?lang=zh_cn"></script>
<link href="../js/calendar/calendar.css" rel="stylesheet" type="text/css" />
<div class="main-div">
<form action="/admin/hotel_store/insert" method="post" name="theForm" enctype="multipart/form-data" >
    {{ csrf_field() }}
