...
<!--遮罩-->
<h1>
      <a href="/admin/user/add" class="btn btn-right btn-add-goods">添加会员</a>
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('goods_name'); ">账号</a></th>
    <th><a href="javascript:listTable.sort('goods_sn'); ">微信头像</a></th>
    <th><a href="javascript:listTable.sort('shop_price'); ">真实名称</a></th>
    <th><a href="javascript:listTable.sort('is_on_sale'); ">微信呢称</a></th>
    <th><a href="javascript:listTable.sort('is_best'); ">手机号码</a></th>
    ...
    <td>{{ $user['id'] }}</td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $user['name'] }}</span></td>
    <td><img height="35" src="{{ $user['avatarUrl'] }}" /></span></td>
    <td align="right"><span onclick="listTable.edit(this, 'edit_goods_price', 72)">{{ $user['realname'] }}</span></td>
    <td align="center"><img src="images/yes.svg" width="20" onclick="listTable.toggle(this, 'toggle_on_sale', 72)" />{{ $user['nickName'] }}</td>
    <td align="center"><img src="images/no.svg" width="20" onclick="listTable.toggle(this, 'toggle_best', 72)" />{{ $user['mobile_phone'] }}</td>
