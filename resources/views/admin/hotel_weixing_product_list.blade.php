...
<!--遮罩-->
<h1>
      <a href="/admin/hotel_weixing_product/add" class="btn btn-right btn-add-goods">添加新商品</a>
 
  
    <span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1">&nbsp;&nbsp;>&nbsp;&nbsp;饭店微信商品列表 </span>
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <td align="center">
      <a href="/hotel_weixing_product/detail/{{ $product['pro_id'] }}" target="_blank" title="查看">查看</a>
      <a href="/admin/hotel_weixing_product/edit/{{ $product['pro_id'] }}" title="编辑">编辑</a>
      <a href="/admin/hotel_weixing_product/delete/{{ $product['pro_id'] }}" title="回收站">回收站</a>
           </td>
  </tr>
    @endforeach
  </table>
