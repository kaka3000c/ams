...
<!--遮罩-->
<h1>
      <a href="/admin/role/add" class="btn btn-right btn-add-goods">添加角色</a>
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('goods_name'); ">角色名称</a></th>
 <th><a href="javascript:listTable.sort('goods_name'); ">操作名称</a></th>
 <th><a href="javascript:listTable.sort('goods_name'); ">操作内容</a></th>
    <th>操作</th>
  </tr>
    @foreach ($role_list['data'] as $role)
    <tr>
    <td><input type="checkbox" name="checkboxes[]" value="72"></td>
    <td>{{ $role['role_id'] }}</td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{$role['role_name'] }}</span></td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{$role['action_list'] }}</span></td>
