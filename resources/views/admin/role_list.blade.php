...
<table cellpadding="3" cellspacing="1">
 ...
 <th><a href="javascript:listTable.sort('goods_name'); ">角色描述</a></th>
    ...
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{$role['role_describe'] }}</span></td>
  
    
    <td align="center">
     
      <a href="goods.php?act=edit&goods_id=72&extension_code=" title="编辑">编辑</a>
      <a href="/admin/role/delete/{{ $role['role_id'] }}" title="移除">移除</a>
