     ...
     <th><a href="javascript:listTable.sort('goods_name'); ">用户账号</a></th>
      <th><a href="javascript:listTable.sort('goods_name'); ">email</a></th>
       <th><a href="javascript:listTable.sort('goods_name'); ">电话</a></th>
        <th><a href="javascript:listTable.sort('goods_name'); ">产品</a></th>
         <th><a href="javascript:listTable.sort('goods_name'); ">产品描述</a></th>
   
 
    <th>操作</th>
  </tr>
    @foreach ($bookinggood_list as $bookinggood)
    <tr>
    <td><input type="checkbox" name="checkboxes[]" value="72"></td>
    <td>{{ $bookinggood->rec_id }}</td>
   
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $bookinggood->user_id }}</span></td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $bookinggood->email }}</span></td>
     <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $bookinggood->tel }}</span></td>
      <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $bookinggood->goods_id }}</span></td>
       <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $bookinggood->goods_desc }}</span></td>
