...
<!--遮罩-->
<h1>
      <a href="/admin/brand/add" class="btn btn-right btn-add-goods">添加品牌</a>
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('goods_name'); ">品牌名称</a></th>
    <th><a href="javascript:listTable.sort('goods_name'); ">logo</a></th>
    <th><a href="javascript:listTable.sort('goods_name'); ">品牌描述</a></th>
    <th><a href="javascript:listTable.sort('goods_name'); ">是否显示</a></th>
    <th>操作</th>
  </tr>
    @foreach ($brand_list['data'] as $brand)
    <tr>
    <td><input type="checkbox" name="checkboxes[]" value="72"></td>
    <td>{{ $brand['brand_id'] }}</td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $brand['brand_name'] }}</span></td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)"><img height="35" src="{{ $brand['brand_logo'] }}" /></span></td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $brand['brand_desc'] }}</span></td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $brand['is_show'] }}</span></td>
    <td align="center">
       <a href="/admin/brand/edit/{{ $brand['brand_id'] }}" target="_blank" title="编辑">编辑</a>
      <a href="/admin/brand/delete/{{ $brand['brand_id'] }}" target="_blank" title="删除">删除</a>
