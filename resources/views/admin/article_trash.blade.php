...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('goods_name'); ">内容</a></th>
    ...
    <td align="center">
      ...
      <a href="/admin/article/cancel_del/{{ $article['article_id'] }}" title="取消回收站">取消回收站</a>
        <a href="/admin/article/real_del/{{ $article['article_id'] }}" title="彻底删除">彻底删除</a>
