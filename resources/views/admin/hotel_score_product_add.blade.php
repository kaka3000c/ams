...
<!--遮罩-->
<h1>
    <a class="btn btn-right" href="goods.php?act=list">饭店积分商品列表</a>
  
    <span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1">&nbsp;&nbsp;>&nbsp;&nbsp;添加新饭店积分商品</span>
...
<div class="tab-div">
    ...
    <div id="tabbody-div">
      ...
      <form enctype="multipart/form-data" action="/admin/hotel_score_product/insert" method="post" name="theForm" >
        {{ csrf_field() }}
        ...
        <table width="90%" id="general-table" align="center" class="gk-table">
          ...
          <tr>
            ...
            <td class="label"> 积分兑换金额：</td>
            <td><input type="text" name="exchange_points" value="0" size="20" />
              <br /><span class="notice-span" style="display:block"  id="noticPoints">(此处需填写金额)兑换该商品时最多可以使用积分的金额</span>
            </td>
          </tr>
