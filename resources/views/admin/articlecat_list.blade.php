...
<!--遮罩-->
<h1>
      <a href="/admin/articlecat/add" class="btn btn-right btn-add-goods">添加文章分类</a>
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('goods_id'); ">编号1</a><img src="images/sort_desc.png"/></th>
    <th><a href="javascript:listTable.sort('goods_name'); ">名称</a></th>
     <th><a href="javascript:listTable.sort('goods_name'); ">类型 id</a></th>
    <th><a href="javascript:listTable.sort('goods_name'); ">关键词</a></th>
    <th><a href="javascript:listTable.sort('goods_name'); ">描述</a></th>
    
 
    <th>操作</th>
  </tr>
    @foreach ($articlecat_list as $articlecat)
    <tr>
    <td><input type="checkbox" name="checkboxes[]" value="72"></td>
    <td>{{ $articlecat['cat_id'] }}</td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $articlecat['cat_name'] }}</span></td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $articlecat['cat_type'] }}</span></td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $articlecat['keywords'] }}</span></td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $articlecat['cat_desc'] }}</span></td>
    
    <td align="center">
       <a href="/admin/articlecat/edit/{{ $articlecat['cat_id']  }}" title="编辑">编辑</a>
      <a href="/admin/articlecat/delete/{{ $articlecat['cat_id']  }}" target="_blank" title="移除">移除</a>
  </tr>
    @endforeach
  </table>
<!-- end goods list -->
