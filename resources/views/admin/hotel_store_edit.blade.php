...
<!--遮罩-->
<h1>
      <a class="btn btn-right" href="/admin/shop">广告列表</a>
  
    <span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1">&nbsp;&nbsp;>&nbsp;&nbsp;编辑广告 </span>
  <div style="clear:both"></div>
</h1><script type="text/javascript" src="../js/calendar.php?lang=zh_cn"></script>
<link href="../js/calendar/calendar.css" rel="stylesheet" type="text/css" />
<div class="main-div">
<form action="/admin/hotel_store/update" method="post" name="theForm" enctype="multipart/form-data" >
    {{ csrf_field() }}
  <table width="100%" id="general-table">
    <tr>
      <td  class="label">
        门店名称</td>
      <td>
        <input type="hidden" name="store_id" value="{{$hotel_store['store_id']}}" size="35" />
        <input type="text" name="name" value="{{$hotel_store['name']}}" size="35" />
     </td>
    </tr>
    ...
    <tr>
      ...
      <td>
          @if ( $hotel_store['logo'])<img src="{{$hotel_store['logo']}}" width="50"   />@endif   
           @if ( !$hotel_store['logo'])广告图片没有上传  @endif   
      </td>
    </tr>
    <tr>    
      <td  class="label">
    ...
    <tr>
      ...
      <td>
        <input type="text" name="address" value="{{$hotel_store['address']}}" size="35" />
      </td>
    </tr>
   ...
   <tr>
      ...
      <td>
        <input type="text" name="mobile" value="{{$hotel_store['mobile']}}" size="35" />
      </td>
    </tr>
       <td class="label">&nbsp;</td>
       <td>
