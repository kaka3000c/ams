...
<!--遮罩-->
<h1>
      <a href="goods.php?act=add" class="btn btn-right btn-add-goods">添加办事处</a>
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('goods_name'); ">办事处</a></th>
     <th><a href="javascript:listTable.sort('goods_name'); ">办事内容</a></th>
    ...
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $agency->agency_name }}</span></td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $agency->agency_desc }}</span></td>
