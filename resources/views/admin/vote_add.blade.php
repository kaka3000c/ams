...
<!--遮罩-->
<h1>
      <a class="btn btn-right" href="/admin/vote">调查主题列表</a>
  
    <span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1">&nbsp;&nbsp;>&nbsp;&nbsp;添加调查主题 </span>
  <div style="clear:both"></div>
</h1><script type="text/javascript" src="../js/calendar.php?lang=zh_cn"></script>
<link href="../js/calendar/calendar.css" rel="stylesheet" type="text/css" />
<div class="main-div">
<form action="/admin/vote/insert" method="post" name="theForm" enctype="multipart/form-data" >
    {{ csrf_field() }}
  <table width="100%" id="general-table">
    <tr>
      <td  class="label">
        调查主题</td>
      <td>
        <input type="text" name="vote_name" value="" size="35" />
        
      </td>
    </tr>
      <tr>
      <td  class="label">能否多选</td>
      <td>
        <input type="radio" name="can_multi" value="0" checked="true">
            不能 &nbsp;&nbsp;&nbsp;&nbsp;
            <input type="radio" name="can_multi" value="1">能
      </td>
    </tr>
