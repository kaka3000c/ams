...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('goods_name'); ">标题</a></th>
    <th><a href="javascript:listTable.sort('goods_sn'); ">内容</a></th>
    <th><a href="javascript:listTable.sort('shop_price'); ">手机号码</a></th>
    <th><a href="javascript:listTable.sort('shop_price'); ">联系人</a></th>
    <th><a href="javascript:listTable.sort('is_on_sale'); ">状态</a></th>
    <th><a href="javascript:listTable.sort('is_best'); ">图片</a></th>
    <th><a href="javascript:listTable.sort('is_new'); ">类型</a></th>
    <th><a href="javascript:listTable.sort('is_hot'); ">创建时间</a></th>
    
    <th>操作</th>
  </tr>
      @foreach ($promoinfo_list as $promoinfo)
    <tr>
    <td><input type="checkbox" name="pro_id[]" value="{{ $promoinfo['id']  }}"></td>
    <td>{{ $promoinfo['id'] }}</td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $promoinfo['title'] }}</span></td>
    <td><span onclick="listTable.edit(this, 'edit_goods_sn', 72)"><img height="35" src="{{ $promoinfo['content'] }}" /></span></td>
          <td align="right"><span onclick="listTable.edit(this, 'edit_goods_price', 72)">{{ $promoinfo['mobile'] }}</span></td>
    <td align="right"><span onclick="listTable.edit(this, 'edit_goods_price', 72)">{{ $promoinfo['contacts'] }}</span></td>
    
    <td align="center">
        @if ( $promoinfo['status'] === 1) <a href="/admin/promoinfo/off_sale/{{ $promoinfo['id']  }}"> <img src="/storage/images/yes.svg" width="20" " />  </a> @endif   
           @if ( $promoinfo['status'] === 0)   <a href="/admin/promoinfo/on_sale/{{ $promoinfo['id']  }}"> <img src="/storage/images/no.svg" width="20" " />  </a>  @endif   
    
    </td>
    
        <td align="right"><span onclick="listTable.edit(this, 'edit_goods_number', 72)"><img src="{{ $promoinfo['images'] }}" width="80" height="80"></span></td>
        <td align="center"><span onclick="listTable.edit(this, 'edit_virtual_sales', 72)">{{ $promoinfo['type'] }}</span></td>
        <td align="center"><span onclick="listTable.edit(this, 'edit_virtual_sales', 72)">{{ $promoinfo['created_at'] }}</span></td>
    <td align="center">
      <a href="/promoinfo/detail/{{ $promoinfo['id'] }}" target="_blank" title="查看">查看</a>
      <a href="/admin/promoinfo/edit/{{ $promoinfo['id'] }}" title="编辑">编辑</a>
      <a href="/admin/promoinfo/delete/{{ $promoinfo['id'] }}" title="回收站">回收站</a>
           </td>
  </tr>
    @endforeach
  </table>
...
<div id="turn-page">
    {{ $promoinfo_list->appends(request()->input())->links() }}
</div>
    </td>
  </tr>
</table>
...
<div id="footer">
共执行 8 个查询，用时 0.117360 秒，Gzip 已禁用，内存占用 2.003 MB<br />
