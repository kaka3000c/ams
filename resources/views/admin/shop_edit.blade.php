...
<h1>
    ...
    <span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1">&nbsp;&nbsp;>&nbsp;&nbsp;编辑商家 </span>
  <div style="clear:both"></div>
</h1><script type="text/javascript" src="../js/calendar.php?lang=zh_cn"></script>
<link href="../js/calendar/calendar.css" rel="stylesheet" type="text/css" />
<div class="main-div">
<form action="/admin/shop/update" method="post" name="theForm" enctype="multipart/form-data" >
    {{ csrf_field() }}
  <table width="100%" id="general-table">
    <tr>
      <td  class="label">
        商家名称</td>
      <td>
        <input type="hidden" name="shop_id" value="{{$shop['shop_id']}}" size="35" />
        <input type="text" name="shop_name" value="{{$shop['shop_name']}}" size="35" />
    ...
    <tr>
      ...
      <td>
        <input type="text" name="mobile" value="{{$shop['mobile']}}" size="35" />
      </td>
    </tr>
          <tr>
      <td  class="label">微信号</td>
      <td>
        <input type="text" name="weixing" value="{{$shop['weixing']}}" size="35" />
      </td>
    </tr>
            <tr>
      <td  class="label">地址</td>
      <td>
        <input type="text" name="address" value="{{$shop['address']}}" size="35" />
      </td>
    </tr>   
          <tr>
      ...
      <td>
         ...
         <textarea name="shop_brief" cols="40" rows="3">{{$shop['shop_brief']}}</textarea>
      </td>
    </tr>  
    <tr>
      <tr>
      <td  class="label">已存在的logo图片</td>
      <td>
          @if ( $shop['shop_logo'])<img src="{{$shop['shop_logo']}}" width="50"   />@endif   
   ...
   <tr>
      <tr>
      <td  class="label">已存在的商家微信二维码</td>
      <td>
          @if ( $shop['qr_code'])<img src="{{$shop['qr_code']}}" width="50"   />@endif   
           @if ( !$shop['qr_code'])logo图片没有上传  @endif   
      </td>
    </tr>
    <tr>    
      <td  class="label">
    ...
    <tr>
      ...
      <td>
        <input type="text" name="contact" value="{{$shop['contact']}}" size="35" />
      </td>
    </tr>
