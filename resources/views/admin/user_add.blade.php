...
<!--遮罩-->
<h1>
      <a class="btn btn-right" href="users.php?act=list">会员列表</a>
...
<form method="post" action="/admin/user/insert" name="theForm" enctype="multipart/form-data">
    {{ csrf_field() }}
<table width="100%" >
  <tr>
    <td class="label">会员名称:</td>
    <td><input type="text" name="name" maxlength="60" value="" /><span class="require-field">*</span></td>
  </tr>
    <tr>
  ...
  <tr>
    ...
    <td>
    <input name="mobile_phone" type="text" size="40" class="inputBg" value=""/>
    </td>
  </tr>
        <tr>
...
<div id="footer">
共执行 4 个查询，用时 0.049716 秒，Gzip 已禁用，内存占用 1.521 MB<br />
