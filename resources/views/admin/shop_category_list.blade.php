...
<!--遮罩-->
<h1>
      <a href="/admin/shopcat/add" class="btn btn-right btn-add-goods">添加分类</a>
 
    <span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1">&nbsp;&nbsp;>&nbsp;&nbsp;  商家类别 </span>
...
<table cellpadding="3" cellspacing="1">
 ...
 <th><a href="javascript:listTable.sort('goods_name'); ">导航栏</a></th>
   ...
   <th><a href="javascript:listTable.sort('goods_name'); ">排序</a></th>
    ...
    @foreach ($shop_category_list as $category)
    <tr>
    <td><input type="checkbox" name="checkboxes[]" value="72"></td>
    <td>{{ $category['shop_cat_id']  }}</td>
    ...
    <td align="center">
      ...
      <a href="/admin/shopcat/edit/{{ $category['shop_cat_id']  }}" title="编辑">编辑</a>
      <a href="/admin/shopcat/delete/{{ $category['shop_cat_id']  }}" target="_blank" title="移除">移除</a>
