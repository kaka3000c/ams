...
<!--遮罩-->
<h1>
      <a href="/admin/bonus/add" class="btn btn-right btn-add-goods">添加红包类型</a>
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('goods_id'); ">类型名称</a><img src="images/sort_desc.png"/></th>
   <th><a href="javascript:listTable.sort('goods_name'); ">发放类型</a></th>
     <th><a href="javascript:listTable.sort('goods_name'); ">红包金额</a></th>
      <th><a href="javascript:listTable.sort('goods_name'); ">订单下限</a></th>
       <th><a href="javascript:listTable.sort('goods_name'); ">发放数量</a></th>
        
   <th><a href="javascript:listTable.sort('goods_name'); ">使用数量</a></th>
 
    <th>操作</th>
  </tr>
    @foreach ($bonustype_list as $bonustype)
    <tr>
   
    <td>{{ $bonustype->type_id }}</td>
   
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $bonustype->type_name }}</span></td>
     <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">
      @if ( $bonustype->send_type  === 0)  按用户发放   @endif
      @if ( $bonustype->send_type  === 1)  按商品发放    @endif
      @if ( $bonustype->send_type  === 2)  按订单金额发放   @endif
      @if ( $bonustype->send_type  === 3)  线下发放的红包   @endif

</span></td>
     <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $bonustype->type_money }}</span></td>
     <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $bonustype->min_amount }}</span></td>
     <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)"></span></td>
        <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)"></span></td>
      
    <td align="center">
     
          <a href="/admin/bonus/edit/id/{{ $bonustype->type_id }}/send_by/{{$bonustype->send_type}}">发放</a> |
                <a href="/admin/bonus/bonus_list/{{ $bonustype->type_id }}">查看</a> |
        <a href="/admin/bonus/edit/{{ $bonustype->type_id }}">编辑</a> |
        <a href="/admin/bonus/delete/{{ $bonustype->type_id }}">移除</a>
        </td>
  </tr>
    @endforeach
  </table>
