...
<!--遮罩-->
<h1>
      <a href="goods.php?act=add" class="btn btn-right btn-add-goods">添加红包类型</a>
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('goods_id'); ">编号</a><img src="images/sort_desc.png"/></th>
     ...
     <th><a href="javascript:listTable.sort('goods_name'); ">类型名称</a></th>
    ...
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $bonustype->send_type }}</span></td>
