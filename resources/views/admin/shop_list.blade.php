...
<!--遮罩-->
<h1>
      <a href="/admin/shop/add" class="btn btn-right btn-add-goods">添加商家</a>
  
  
    <span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1">&nbsp;&nbsp;>&nbsp;&nbsp;商家列表 </span>
  ...
  <form action="javascript:searchArticle()" name="searchForm">
    ...
    <select name="cat_id">
      <option value="0">全部分类</option>
        <option value="1" cat_type="2">系统分类</option><option value="2" cat_type="3">&nbsp;&nbsp;&nbsp;&nbsp;网店信息</option><option value="3" cat_type="4">&nbsp;&nbsp;&nbsp;&nbsp;网店帮助分类</option><option value="6" cat_type="1">水果资讯</option><option value="7" cat_type="1">&nbsp;&nbsp;&nbsp;&nbsp;苹果资讯</option><option value="8" cat_type="1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;苹果一</option>    </select>
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('goods_name'); ">名称</a></th>
     <th><a href="javascript:listTable.sort('goods_name'); ">logo</a></th>
    <th><a href="javascript:listTable.sort('goods_name'); ">电话</a></th>
    <th><a href="javascript:listTable.sort('goods_name'); ">联系人</a></th>
     <th><a href="javascript:listTable.sort('goods_name'); ">微信</a></th>
      <th><a href="javascript:listTable.sort('goods_name'); ">二微码</a></th>
       <th><a href="javascript:listTable.sort('goods_name'); ">地址</a></th>
    ...
    <td>{{ $shop['shop_id'] }}</td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $shop['shop_name'] }}</span></td>
                                                                                                     <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)"><img src="{{ $shop['shop_logo'] }}" width="80"></span></td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $shop['mobile'] }}</span></td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $shop['contact'] }}</span></td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $shop['weixing'] }}</span></td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $shop['address'] }}</span></td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)"><img src="{{ $shop['qr_code'] }}" width="80"></span></td>
    
    <td align="center">
      <a href="/admin/shop/edit/{{ $shop['shop_id'] }}" target="_blank" title="编辑">编辑</a>
      <a href="/admin/shop/delete/{{ $shop['shop_id'] }}" target="_blank" title="删除">删除</a>
  ...
  <tr>
    <td style="text-align: left">
      ...
      <select name="target_cat" style="display:none">
        <option value="0">请选择...</option><option value="26" >家用电器</option><option value="27" >&nbsp;&nbsp;&nbsp;&nbsp;大家电</option><option value="28" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;平板电脑</option><option value="32" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;冰箱</option><option value="29" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;家用空调</option><option value="30" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;家电配件</option><option value="31" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;洗衣机</option><option value="25" >数码时尚</option><option value="18" >智能硬件</option><option value="22" >移动电源</option><option value="6" >手机</option><option value="9" >&nbsp;&nbsp;&nbsp;&nbsp;电池</option><option value="8" >&nbsp;&nbsp;&nbsp;&nbsp;耳机</option><option value="19" >配件</option><option value="24" >&nbsp;&nbsp;&nbsp;&nbsp;数码时尚</option><option value="20" >&nbsp;&nbsp;&nbsp;&nbsp;保护壳</option><option value="16" >服装</option><option value="12" >充值卡</option><option value="1" >手机类型</option><option value="3" >&nbsp;&nbsp;&nbsp;&nbsp;小型手机</option><option value="4" >&nbsp;&nbsp;&nbsp;&nbsp;3G手机</option>      </select>
            <!--二级主菜单：转移供货商-->
