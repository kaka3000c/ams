...
<h1>
    ...
    <span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1">&nbsp;&nbsp;>&nbsp;&nbsp;编辑商品 </span>
      ...
      <form enctype="multipart/form-data" action="/admin/product/update" method="post" name="theForm" >
        ...
        <table width="90%" id="general-table" align="center" class="gk-table">
          ...
          <tr>
            ...
            <td><input type="text" name="goods_number" value="{{ $product['goods_number'] }}" size="20" />
        ...
        <table width="90%" id="mix-table" align="center">
            ...
            <td>
               ...
               @if ( $product['is_popular'] === 1) <input type="checkbox" name="is_popular"  checked="checked" /> @endif   
               @if ( $product['is_popular'] === 0) <input type="checkbox" name="is_popular"   />   @endif 
                爆款
                <input type="checkbox" name="is_best" value="{{ $product['is_best'] }}" 
                        @if ( $product['is_best'] === 1)  checked  @endif  />精品
                <input type="checkbox" name="is_new" value="{{ $product['is_new'] }}"  
                        @if ( $product['is_new'] === 1)  checked  @endif />新品 
                       <input type="checkbox" name="is_hot" value="{{ $product['is_hot'] }}" 
                               @if ( $product['is_hot'] === 1)  checked  @endif />热销</td>
          </tr>
               <tr>
