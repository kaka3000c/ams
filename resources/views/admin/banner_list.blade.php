  ...
  <tr>
    ...
    <td><img height="35" src="{{ $banner['image'] }}" /></span></td>
      <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $banner['content'] }}</span></td>
            ...
            @if ( $banner['enabled'] === 1) <a href="/admin/banner/off_enable/{{ $banner['banner_id']  }}"> <img src="/storage/images/yes.svg" width="20" " />  </a> @endif   
           @if ( $banner['enabled'] === 0)   <a href="/admin/banner/on_enable/{{ $banner['banner_id']  }}"> <img src="/storage/images/no.svg" width="20" " />  </a>  @endif   
    ...
    <td align="center">
    <a href="/admin/banner/edit/{{ $banner['banner_id'] }}" target="_blank" title="编辑">编辑</a>
      <a href="/admin/banner/delete/{{ $banner['banner_id'] }}" target="_blank" title="删除">删除</a>
  </tr>
    @endforeach
  </table>
<!-- end goods list -->
