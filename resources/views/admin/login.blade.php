...
.panel-hint{top: 3%;}
.login-body{ background: url(https://account.shopex.cn/pic/cms/cms5b0e76abea02f.jpg) no-repeat center center; }
...
<script type="text/javascript" src="../js/utils.js"></script><script type="text/javascript" src="js/validator.js"></script><script type="text/javascript" src="../js/transport.js"></script><script language="JavaScript">
<!--
// 这里把JS用到的所有语言都赋值到这里
...
<form class="login-body" method="post" action="/admin/signin" name='theForm' >
      {{ csrf_field() }}
  <!--<div class="login-hd">
  ...
  <div class="center-wrap" id="centerWrap">
    ...
    <div class="top-ibg-wrap">
      <a href="http://ecstore.shopex.cn/?from=ecshoplogin" target="_blank" class="top-ibg-480600"></a>
    </div>
    <div class="z-bd">
      ...
      <div class="login-panel" id="loginPanel">
       <h3 class="logo-text ecshop-logo">
        ...
        <div class="controls first">
          ...
          <input type="text" name="username" placeholder="请填写您注册的邮箱或手机" />
        </div>
...
<div class="copy-right">&copy; 2003-2018 ShopEx,Inc.All rights reserved.</div>
<script language="JavaScript">
 ...
 (function(win,doc){
  ...
  var dom ="<h3 class='logo-text yunqi-logo'><div class='logo'></div><p class='text'>云起登录</p></h3><div class='main'><span class='error-hint'  style='display:none'  id='login_error_msg'></span><iframe id='loginFrame' src='https://openapi.shopex.cn/oauth/authorize?response_type=code&client_id=yogfss4l&redirect_uri=http%3A%2F%2Flocalhost%2Fecshop%2Fecshop%2Fadmin%2Fprivilege.php%3Fact%3Dlogin%26type%3Dyunqi&view=auth_ecshop' height='220' frameborder='0' scrolling='no'></iframe><div class='cloud-passw'><a target='_blank' href='https://account.shopex.cn/forget?' style='float:right;'>忘记密码?</a></div> </div>";
  ...
  if (!is_active) {
    ...
    elsePanel.getElementsByTagName('p')[0].innerHTML = 'ECshop账号';
    get_certificate();
  }
