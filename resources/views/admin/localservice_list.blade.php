...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <td align="center">
        @if ( $info['is_show'] === 1) <a href="/admin/localservice/off_show/{{ $info['id']  }}"> <img src="/storage/images/yes.svg" width="20" " />  </a> @endif   
           @if ( $info['is_show'] === 0)   <a href="/admin/localservice/on_show/{{ $info['id']  }}"> <img src="/storage/images/no.svg" width="20" " />  </a>  @endif   
