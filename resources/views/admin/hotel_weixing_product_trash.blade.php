...
<!-- 商品列表 -->
<form enctype="multipart/form-data" action="/admin/product/batch_del" method="post" name="theForm" >
            {{ csrf_field() }}
    ...
    <td align="center">
      ...
      <a href="/admin/product/cancel_del/{{ $product['pro_id'] }}" title="取消回收站">取消回收站</a>
        <a href="/admin/product/real_del/{{ $product['pro_id'] }}" title="彻底删除">彻底删除</a>
