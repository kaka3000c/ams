...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('goods_name'); ">操作时间</a></th>
     <th><a href="javascript:listTable.sort('goods_name'); ">操作员</a></th>
    <th><a href="javascript:listTable.sort('goods_name'); ">操作内容</a></th>
    <th><a href="javascript:listTable.sort('goods_name'); ">操作详情</a></th>
    <th><a href="javascript:listTable.sort('goods_name'); ">ip</a></th>
 
    <th>操作</th>
  </tr>
    @foreach ($adminlog_list as $adminlog)
    <tr>
    <td><input type="checkbox" name="checkboxes[]" value="72"></td>
    <td>{{ $adminlog['log_id'] }}</td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $adminlog['log_time'] }}</span></td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $adminlog['user_id'] }}</span></td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $adminlog['log_info'] }}</span></td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $adminlog['ip_address'] }}</span></td>
