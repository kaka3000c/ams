...
<!--遮罩-->
<h1>
      <a class="btn btn-right" href="/admin/brand">商家列表</a>
...
<div class="main-div">
<form action="/admin/brand/update" method="post" name="theForm" enctype="multipart/form-data" >
    {{ csrf_field() }}
  <table width="100%" id="general-table">
    <tr>
      <td  class="label">
        商家名称</td>
      <td>
        <input type="hidden" name="brand_id" value="{{$brand['brand_id']}}" size="35" />
        <input type="text" name="brand_name" value="{{$brand['brand_name']}}" size="35" />
    ...
    <tr>
      ...
      <td>
          @if ( $brand['brand_logo'])<img src="{{$brand['brand_logo']}}" width="50"   />@endif   
           @if ( !$brand['brand_logo'])logo图片没有上传  @endif   
      </td>
    </tr>
    <tr>    
      <td  class="label">
    ...
    <tr>
      ...
      <td>
        <input type="text" name="brand_desc" value="{{$brand['brand_desc']}}" size="35" />
      </td>
    </tr>
