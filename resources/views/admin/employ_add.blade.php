...
<div class="tab-div">
  ...
  <div id="tabbody-div">
    <form  action="/admin/employ/insert" method="post" enctype="multipart/form-data" name="theForm" onsubmit="return validate();">
    {{ csrf_field() }}
      ...
      <tr>
        ...
        <td>
        <input type="radio" name="is_show" value="1" checked> 显示      <input type="radio" name="is_show" value="0" > 不显示<span class="require-field">*</span>        </td>
      </tr>
        
           <tr>
        <td class="narrow-label">来源</td>
        <td><input type="text" name="source" maxlength="60" value="" /></td>
      </tr>
   </table>
    <table>
     <tr><td>
