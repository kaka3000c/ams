...
<!--遮罩-->
<h1>
      <a class="btn btn-right" href="articlecat.php?act=list">文章分类</a>
...
<form method="post" action="/admin/articlecat/insert" name="theForm"  >
    {{ csrf_field() }}
<table cellspacing="1" cellpadding="3" width="100%">
  <tr>
    <td class="label">文章分类名称</td>
    <td><input type="text" name="cat_name" maxlength="60" size = "30" value="" /><span class="require-field">*</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2" align="center"><br />
      ...
      <input type="hidden" name="old_catname" value="" />
    </td>
  </tr>
</table>
</form>
...
<div id="footer">
共执行 2 个查询，用时 0.036623 秒，Gzip 已禁用，内存占用 1.480 MB<br />
