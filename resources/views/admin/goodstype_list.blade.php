...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    @foreach ($goodstype_list as $goodstype)
    <tr>
    <td><input type="checkbox" name="checkboxes[]" value="72"></td>
    <td>{{ $goodstype['cat_id'] }}</td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $goodstype['cat_name'] }}</span></td>
