...
<div class="main-div">
  <form action="/admin/shopcat/insert" method="post" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
   {{ csrf_field() }}
      ...
      <tr>
        ...
        <td>
            <select name="parent_id" >
                 ...
                 <option value="{{ $category['shop_cat_id'] }}" >{{ $category['cat_name'] }}</option>
