...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <td align="center">
        @if ( $info['is_show'] === 1) <a href="/admin/house/off_show/{{ $info['id']  }}"> <img src="/storage/images/yes.svg" width="20" " />  </a> @endif   
           @if ( $info['is_show'] === 0)   <a href="/admin/house/on_show/{{ $info['id']  }}"> <img src="/storage/images/no.svg" width="20" " />  </a>  @endif   
    ...
    <td align="center">
      <a href="/house/detail/{{ $info['id'] }}" target="_blank" title="查看">查看</a>
      <a href="/admin/house/edit/{{ $info['id'] }}" title="编辑">编辑</a>
      <a href="/admin/house/delete/{{ $info['id'] }}" title="回收站">回收站</a>
           </td>
  </tr>
    @endforeach
  </table>
