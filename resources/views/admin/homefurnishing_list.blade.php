...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <tr>
    <td><input type="checkbox" name="pro_id[]" value="{{ $info['id']  }}"></td>
    <td>{{ $info['id'] }}</td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $info['title'] }}</span></td>
    <td><span onclick="listTable.edit(this, 'edit_goods_sn', 72)"><img height="35" src="{{ $info['content'] }}" /></span></td>
          <td align="right"><span onclick="listTable.edit(this, 'edit_goods_price', 72)">{{ $info['mobile'] }}</span></td>
    <td align="right"><span onclick="listTable.edit(this, 'edit_goods_price', 72)">{{ $info['contacts'] }}</span></td>
    
    <td align="center">
        @if ( $info['is_show'] === 1) <a href="/admin/homefurnishing/off_show/{{ $info['id']  }}"> <img src="/storage/images/yes.svg" width="20" " />  </a> @endif   
           @if ( $info['is_show'] === 0)   <a href="/admin/homefurnishing/on_show/{{ $info['id']  }}"> <img src="/storage/images/no.svg" width="20" " />  </a>  @endif   
    
    </td>
    
        <td align="right"><span onclick="listTable.edit(this, 'edit_goods_number', 72)"><img src="{{ $info['images'] }}" width="80" height="80"></span></td>
        <td align="center"><span onclick="listTable.edit(this, 'edit_virtual_sales', 72)">{{ $info['type'] }}</span></td>
        <td align="center"><span onclick="listTable.edit(this, 'edit_virtual_sales', 72)">{{ $info['created_at'] }}</span></td>
    <td align="center">
      <a href="/localservice/detail/{{ $info['id'] }}" target="_blank" title="查看">查看</a>
      <a href="/admin/localservice/edit/{{ $info['id'] }}" title="编辑">编辑</a>
      <a href="/admin/localservice/delete/{{ $info['id'] }}" title="回收站">回收站</a>
           </td>
  </tr>
    @endforeach
  </table>
...
<div id="turn-page">
    {{ $info_list->appends(request()->input())->links() }}
</div>
    </td>
  </tr>
</table>
