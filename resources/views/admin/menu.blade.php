  ...
  <div id="main-div">
    <div id="menu-list">
      <ul class="menu" id="menu-ul">
          ...
          <li id="sub-menu-06_pack_list" class="menu-item" onclick="showact(this, event)"><a href="/admin/hotel_score_product" target="main-frame">饭店积分商品列表</a></li>
          <li id="sub-menu-06_pack_list" class="menu-item" onclick="showact(this, event)"><a href="/admin/hotel_weixing_product" target="main-frame">饭店微信商品列表</a></li>
          ...
          促销管理                    <div class="submenu">
            ...
            <ul>
                        ...
                        <li id="sub-menu-04_bonustype_list" class="menu-item" onclick="showact(this, event)"><a href="/admin/coupon" target="main-frame">优惠劵</a></li>
          ...
          订单管理                    <div class="submenu">
            ...
            <ul>
                       ...
                       <li id="sub-menu-02_order_list" class="menu-item" onclick="showact(this, event)"><a href="/admin/hotel_order" target="main-frame">饭店订单列表</a></li>
                        <li id="sub-menu-02_order_list" class="menu-item" onclick="showact(this, event)"><a href="/admin/hotel_score_order" target="main-frame">饭店积分订单列表</a></li>
 </ul>
          </div>
                  </li>
          ...
          广告管理                    <div class="submenu">
            ...
            <ul>
                          ...
                          <li id="sub-menu-02_goods_add" class="menu-item" onclick="showact(this, event)"><a href="/admin/shopbanner" target="main-frame">商家广告列表</a></li>
...
<li id="sub-menu-03_article_list" class="menu-item" onclick="showact(this, event)"><a href="/admin/article/trash" target="main-frame">文章回收站</a></li>
                          ...
                          <li id="sub-menu-vote_list" class="menu-item" onclick="showact(this, event)"><a href="/admin/vote" target="main-frame">在线调查</a></li>
                        </ul>
          </div>
                  </li>
          ...
          商家管理                    <div class="submenu">
            ...
            <ul>
                          <li id="sub-menu-admin_list" class="menu-item" onclick="showact(this, event)"><a href="/admin/shop" target="main-frame">商家列表</a></li>
                           <li id="sub-menu-admin_list" class="menu-item" onclick="showact(this, event)"><a href="/admin/shopcat" target="main-frame">商家类别</a></li>
                          <li id="sub-menu-admin_list" class="menu-item" onclick="showact(this, event)"><a href="/admin/hotel_store" target="main-frame">饭店门店管理</a></li>
...
<li key="10_priv_admin" class="icon-priv" data-url="/admin/shop" data-key="admin_list" name="menu" onclick="showsub(this)">
          招聘管理                    <div class="submenu">
            <div class="title">招聘管理</div>
            <ul>
                          <li id="sub-menu-admin_list" class="menu-item" onclick="showact(this, event)"><a href="/admin/employ" target="main-frame">招聘列表</a></li>
   ...
   <li key="11_system" class="icon-system" data-url="shop_config.php?act=list_edit" data-key="01_shop_config" name="menu" onclick="showsub(this)">
          用户发布内容管理                    <div class="submenu">
            <div class="title">用户发布内容管理  </div>
            <ul>
                          <li id="sub-menu-01_shop_config" class="menu-item" onclick="showact(this, event)"><a href="/admin/promoinfo" target="main-frame">优惠信息</a></li>
                          <li id="sub-menu-01_shop_config" class="menu-item" onclick="showact(this, event)"><a href="/admin/promoinfo/trash" target="main-frame">优惠信息回收站</a></li>
                          <li id="sub-menu-021_reg_fields" class="menu-item" onclick="showact(this, event)"><a href="/admin/localservice" target="main-frame">本地服务信息</a></li>
                          <li id="sub-menu-021_reg_fields" class="menu-item" onclick="showact(this, event)"><a href="/admin/localservice/trash" target="main-frame">本地服务信息回收站</a></li>
                          <li id="sub-menu-02_payment_list" class="menu-item" onclick="showact(this, event)"><a href="/admin/house" target="main-frame">房产信息</a></li>
                          <li id="sub-menu-02_payment_list" class="menu-item" onclick="showact(this, event)"><a href="/admin/house/trash" target="main-frame">房产信息回收站</a></li>
                          <li id="sub-menu-03_shipping_list" class="menu-item" onclick="showact(this, event)"><a href="/admin/homefurnishing" target="main-frame">家居信息</a></li>
                          <li id="sub-menu-03_shipping_list" class="menu-item" onclick="showact(this, event)"><a href="/admin/homefurnishing/trash" target="main-frame">家居信息回收站</a></li>
                          <li id="sub-menu-04_mail_settings" class="menu-item" onclick="showact(this, event)"><a href="/admin/education" target="main-frame">教育信息</a></li>
                          <li id="sub-menu-04_mail_settings" class="menu-item" onclick="showact(this, event)"><a href="/admin/education/trash" target="main-frame">教育信息回收站</a></li>
                          <li id="sub-menu-05_area_list" class="menu-item" onclick="showact(this, event)"><a href="/admin/car" target="main-frame">二手汽车信息</a></li>
                          <li id="sub-menu-05_area_list" class="menu-item" onclick="showact(this, event)"><a href="/admin/car/trash" target="main-frame">二手汽车信息回收站</a></li>
                          <li id="sub-menu-07_cron_schcron" class="menu-item" onclick="showact(this, event)"><a href="cron.php?act=list" target="main-frame">婚恋中心</a></li>
          ...
          系统设置                    <div class="submenu">
            ...
            <ul>
                          ...
                          <li id="sub-menu-08_friendlink_list" class="menu-item" onclick="showact(this, event)"><a href="/admin/friendlink" target="main-frame">友情链接</a></li>
