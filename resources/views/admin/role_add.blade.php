...
<table cellspacing='1' id="list-table">
    ...
    <td>{{ $priv['action_code'] }} echo trans('failed'); </td>
    
    <td>   
        @foreach ($priv['priv'] as $list)
         <input type="checkbox" name="action_code[]" value="{{ $list['action_code'] }}" id="{{ $list['action_code'] }}" class="checkbox"/>
        @lang('auth.goods') {{ $list['action_code'] }}
