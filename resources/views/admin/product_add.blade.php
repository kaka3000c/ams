...
<!--            <td><input type="text" name="goods_number" value="1" size="20"  /><br />-->
            ...
            <td>
                <input type="checkbox" name="is_popular" value="1"  />爆款
                <input type="checkbox" name="is_best" value="1"  />精品 <input type="checkbox" name="is_new" value="1"  />新品 <input type="checkbox" name="is_hot" value="1"  />热销</td>
          </tr>
