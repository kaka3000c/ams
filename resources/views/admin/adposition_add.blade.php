...
<!--遮罩-->
<h1>
      <a class="btn btn-right" href="ad_position.php?act=list">广告位置</a>
  ...
  <form action="/admin/adposition/insert" method="post" name="theForm" enctype="multipart/form-data">
      {{ csrf_field() }}
    <table width="100%">
      <tr>
...
<div id="footer">
共执行 2 个查询，用时 0.018399 秒，Gzip 已禁用，内存占用 1.459 MB<br />
