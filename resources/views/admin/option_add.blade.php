...
<!--遮罩-->
<h1>
      <a class="btn btn-right" href="/admin/vote">调查选项列表</a>
  
    <span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1">&nbsp;&nbsp;>&nbsp;&nbsp;添加调查选项 </span>
...
<div class="main-div">
    ...
    <table cellpadding="3" cellspacing="1">
        <tr>
        <th class="checks"  align="center"><input  type="checkbox"></th>
        <th  align="center">编号</th>
        <th align="center">调查选项</th>
        <th align="center">选项排序</th>
        <th align="center">操作</th>
      </tr>
      @foreach ($vote_option_list as $vote_option)
    <tr>
    <td align="center"><input type="checkbox" name="checkboxes[]" value="{{ $vote_option['option_id'] }}"></td>
    <td align="center">{{ $vote_option['option_id'] }}</td>
    <td   align="center">{{ $vote_option['option_name'] }}</td>
                                                                                                     
    <td  align="center">{{ $vote_option['option_order'] }}</td>
    
    <td align="center">
     
      <a href="/admin/vote/option_delete/{{ $vote_option['option_id'] }}"  title="删除">删除</a>
...
<form action="/admin/vote/option_insert" method="post" name="theForm" enctype="multipart/form-data" >
    {{ csrf_field() }}
  <table width="100%" id="general-table">
     <tr>
      ...
      <td>
        <input type="hidden" name="vote_id" value="{{ $vote_id }}" size="35" />
    ...
    <tr>
      <td  class="label">
        投票选项</td>
      <td>
        <input type="text" name="option_name" value="" size="35" />
