...
<h1>
  ...
  <a class="btn btn-right" href="http://yunqi.shopex.cn/products/huodiantong" target="_blank">快速录入商品</a>
    ...
    <span class="action-span1"><a href="index.php?act=main"> 友情链接列表</a> </span><span id="search_id" class="action-span1">&nbsp;&nbsp;>&nbsp;&nbsp;商品列表 </span>
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('goods_id'); ">编号</a><img src="images/sort_desc.png"/></th>
     ...
     <th><a href="javascript:listTable.sort('goods_name'); ">用户账号</a></th>
      <th><a href="javascript:listTable.sort('goods_name'); ">email</a></th>
       <th><a href="javascript:listTable.sort('goods_name'); ">留言标题</a></th>
        <th><a href="javascript:listTable.sort('goods_name'); ">留言内容</a></th>
         <th><a href="javascript:listTable.sort('goods_name'); ">留言状态</a></th>
    ...
    <td>{{ $feedback->msg_id }}</td>
   
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $feedback->user_name }}</span></td>
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $feedback->user_email }}</span></td>
     <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $feedback->msg_title }}</span></td>
      <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $feedback->msg_content }}</span></td>
       <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 72)">{{ $feedback->msg_status }}</span></td>
