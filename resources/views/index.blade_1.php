...
<div class="indexpage">
    ...
    <div class="indexpage_right">
        <div class="ad_right_1">
            <img src="http://www.0668zdm.com/storage/images/banner/20190629155543.jpeg" width="330" >
        </div>
    ...
    <div class="indexpage">
        ...
        <ul class="brand">
             ...
             <li> <a href="/shop/detail/{{$shop['shop_id'] }}"><img src="{{$shop['shop_logo'] }}"  class="goodsimg" width="100 height="100"></a></li>  
            @endforeach
        </ul>
