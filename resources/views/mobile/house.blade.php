...
<div style="width:100%;height:50px;line-height:50px;text-align:center;  background-color:#f30000;color:#fff;" >发布房产信息</div>
<div style='width:100%;'>公告: 本平台不对任何人提供任何形式的担保。请不要发布违法信息，将追究法律责任。</div>
<form class="form-horizontal" action="{{ URL('/mobile/house/insert') }}" method="POST" enctype="multipart/form-data" class="banner-upload">
