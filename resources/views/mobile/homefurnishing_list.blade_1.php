...
<script src="/js/jquery-3.2.1.min.js"></script>
 ...
 <ul style=" width:90%;margin:0 auto; height:78px;">
       @foreach ($homefurnishing_list as $homefurnishing)
      <li style="height:78px;margin-top:8px;border-bottom:#d6d6d6 solid 1px; "> 
          ...
          <div class="article_pic" style="width:20%;height:78px;float:left;">
           <a href="http://www.0668zdm.com/{{$homefurnishing['images']}}" style="display:block;">  
               <div class="zoomImage" style="background-image:url({{$homefurnishing['images']}}); width:100%;
    height:0;
    padding-bottom: 100%;
    overflow:hidden;
    ...
    background-size:cover;">
          ...
          <div class="article_title" style="width:76%;line-height:18px;max-width:300px;height:78px;float:right;color:#8e8e8e;">
           <a href="/mobile/homefurnishing/detail/{{$homefurnishing['id']}}" style="text-decoration:none;color:#333333;">    {{$homefurnishing['title']}}</a>
