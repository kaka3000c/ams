...
<form class="form-horizontal" action="{{ URL('/mobile/jiaoyou/insert') }}" method="POST" enctype="multipart/form-data" class="banner-upload">
      ...
      {{ csrf_field() }}
       <table width="95%"  style="margin:0 auto;">
           ...
           <tr style="height:45px;">
              ...
              <td><input type="text" name="nickName" value=""  style="width:200px;border:1px solid #d8d8d8; height:35px;line-height:35px;box-shadow:0px #ffffff;font-size:16px;" /> </td>
           </tr>
           <tr style="height:45px;">
  ...
  <option value ="2">女</option>
           ...
           <tr style="height:45px;">
              ...
              <td><input value="" class="" readonly name="birthday" id="birthday" type="text" style="width:200px;border:1px solid #d8d8d8; height:35px;line-height:35px;box-shadow:0px #ffffff;font-size:16px;" > </td>
           </tr>
             <tr style="height:45px;">
              <td  class="label"> 身高</td>
              <td><input type="text" name="height" value=""  style="width:200px;border:1px solid #d8d8d8; height:35px;line-height:35px;box-shadow:0px #ffffff;font-size:16px;" />厘米 </td>
           </tr>
            <tr style="height:45px;">
              <td  class="label"> 体重</td>
              <td><input type="text" name="weight" value=""  style="width:200px;border:1px solid #d8d8d8; height:35px;line-height:35px;box-shadow:0px #ffffff;font-size:16px;" /> 斤</td>
           </tr>
            <tr style="height:45px;">
            ...
            <tr style="height:45px;">
              ...
              <td> <input type="text" name="salary" value=""  style="width:200px;border:1px solid #d8d8d8; height:35px;line-height:35px;box-shadow:0px #ffffff;font-size:16px;" /></td>
           </tr>
            <tr style="height:45px;">
