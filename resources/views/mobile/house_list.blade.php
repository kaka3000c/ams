...
<script src="/js/jquery-3.2.1.min.js"></script>
    ...
    <!-- SEO 相关 -->
            ...
            <title>房产频道--茂名值得买 | 茂名品质消费分享网站_网购决策门户</title>
 ...
 @include('mobile/header')
  <div style=" width:90%;margin:0 auto; height:55px;line-height:55px;  margin-top: 45px;font-size:18px;font-weight:900;">
      <ul>
      <li  style="float:left;width:33%;text-align: center;"><a href="/mobile/fc">新房</a></li>
      <li style="float:left;width:33%;text-align: center;"><a href="/mobile/second">二手房</a></li> 
      <li style="float:left;width:33%;text-align: center;"><a href="/mobile/rent">租房</a></li>
      </ul>
  </div>
