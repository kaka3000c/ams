...
<script >
 ...
 $("#img-upload").on('submit',function(e){
        ...
        $.ajax({
            ...
            type: 'POST',
            url: '/mobile/localservice/insert' ,
            data: formData ,
            processData:false,
...
<div style="width:100%;height:50px;line-height:50px;text-align:center;  background-color:#f30000;color:#fff;" >发布本地服务</div>
<div style='width:100%;'>公告: 本平台不对任何人提供任何形式的担保。请不要发布违法信息，将追究法律责任。</div>
<form class="form-horizontal" action="{{ URL('/mobile/localservice/insert') }}" method="POST" enctype="multipart/form-data" class="banner-upload">
      ...
      {{ csrf_field() }}
       <table width="95%"  style="margin:0 auto;">
           ...
           <tr style="height:45px;">
              ...
              <td><input type="text" name="title" value=""  style="width:200px;border:1px solid #d8d8d8; height:35px;line-height:35px;box-shadow:0px #ffffff;font-size:16px;" /> </td>
           </tr>
            <tr style="height:45px;">
              <td  class="label"> 详细内容</td>
              <td> <textarea rows="3" cols="20"  name="content" style="width:200px;border:1px solid #d8d8d8; height:100px;line-height:35px;box-shadow:0px #ffffff;font-size:16px;">
                          ...
                          <option value ="3">装修服务</option>
                           <option value ="4">商务服务</option>
                            <option value ="5">教育培训</option>
                             <option value ="6">汽车服务</option>
                              <option value ="7">婚庆服务</option>
                              <option value ="8">旅游休闲</option>
                              <option value ="9">宠物服务</option>
           ...
           <tr style="height:45px;">
              ...
              <td><input value="" class="" readonly name="contacts" id="contacts" type="text" style="width:200px;border:1px solid #d8d8d8; height:35px;line-height:35px;box-shadow:0px #ffffff;font-size:16px;" > </td>
           </tr>
             <tr style="height:45px;">
              <td  class="label"> 电话</td>
              <td><input type="text" name="mobile" value=""  style="width:200px;border:1px solid #d8d8d8; height:35px;line-height:35px;box-shadow:0px #ffffff;font-size:16px;" />厘米 </td>
           </tr>
