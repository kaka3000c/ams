...
<div class="recommend_top" style=" height:118px;border:0px;">  
  
   
    
    
</div>
<div class="recommend" style=" width:169px;height:37px;border:0px;">  
  
</div>
<div>{!! QrCode::size(100)->generate($url); !!}</div>

<div class="activy_title">--活动规则--</div>
<div  class="activy_content">1.当有新用户(此前未授权登录过茂名值得买网)通过您分享的二维码进入网站并授权登录，系统将记录您已分享给一位好友！</div>
<div>   </div>
