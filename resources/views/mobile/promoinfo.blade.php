...
<div style="width:100%;height:50px;line-height:50px;text-align:center;  background-color:#f30000;color:#fff;" >发布优惠信息</div>
<div style='width:100%;color:#dadada;'>公告: 本平台不对任何人提供任何形式的担保。请不要发布违法信息，将追究法律责任。</div>
<form class="form-horizontal" action="{{ URL('/mobile/promoinfo/insert') }}" method="POST" enctype="multipart/form-data" class="banner-upload">
      ...
      {{ csrf_field() }}
       <table width="95%"  style="margin:0 auto;">
           ...
           <tr style="height:45px;">
              ...
              <td><input type="text" name="title" value=""  style="width:100%;border:1px solid #d8d8d8; height:35px;line-height:35px;box-shadow:0px #ffffff;font-size:16px;" /> </td>
           </tr>
           <tr style="height:45px;">
            ...
            <tr style="height:45px;">
              ...
              <td> <textarea rows="3" cols="20"  name="content" style="width:100%;border:1px solid #d8d8d8; height:100px;line-height:35px;box-shadow:0px #ffffff;font-size:16px;">
