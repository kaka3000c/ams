    ...
    <div id="goodsInfo" class="clearfix">
      ...
      <div class="textInfo">
        <form action="javascript:addToCart(72)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
          <div class="goods_style_name"> {{ $product->name }} </div>
          <ul>
                        <li class="clearfix">
              <dd>
       ...
       <strong>累计销量：</strong>0       </dd>
          ...
          <form class="wst-lo-form" method="post" action="/cart">
                {{ csrf_field() }}
                 <input type='text' id='pro_id' name="pro_id" class='ipt text' value='{{ $product->pro_id }}'>
                 
                 <input name="login" type="submit" value='立即购买'/>
	    </form>
      </div>
    </div>
      @endforeach
     ...
     <div class="box_1">
      ...
      <div class="boxCenterList">
       ...
       <div id="buy_pagebar" class="f_r" style="margin-top:10px">
        <form name="selectPageForm" action="/ecshop/ecshop/goods.php" method="get">
                <div id="buy_pager">
      ...
      <form action="javascript:;" onsubmit="submitComment(this)" method="post" name="commentForm" id="commentForm">
       <table width="710" border="0" cellspacing="5" cellpadding="0">
        ...
        <tr>
          ...
          <img src="captcha.php?1875352572" alt="captcha" onClick="this.src='captcha.php?'+Math.random()" class="captcha">
          </div>
