...
<footer  style=" width:100%;background: #fff; height:45px;position:fixed; bottom: 0px;z-index:3;"> 
    ...
    <div  style="position:fixed; bottom: 0px; width:100%; height:45px;background: #fff;">
                  ...
                  <ul style="height:45px;background: #fff;">
                        <li style="width:20%;height:45px;line-height:45px;float:left;text-align:center;background: #fff;" ><a href="/jiaju_mobile/index" style="width:100%;text-align:center;">首页</a></li>
                      <li style="width:20%;height:45px;line-height:45px;float:left;text-align:center;background: #fff;" ><a href="/jiaju_mobile/category" style="width:100%;text-align:center;">分类</a></li>
                      <li style="width:20%;height:45px;z-index:-1;line-height:45px;float:left;text-align:center;background: #fff;" class="open"  >
           ...
           line-height: 38px;text-align: center;
            border-radius: 50%;color: #ffffff;background-color: #f50000;display: block;margin:0 auto;font-size:18px;font-weight:900;" >+</div>
                      ...
                      <li style="width:20%;height:45px;line-height:45px;float:left;text-align:center;background: #fff;" ><a href="/jiaju_mobile/index" style="width:100%;text-align:center;">推荐</a></li>
                       <li style="width:20%;height:45px;line-height:45px;float:left;text-align:center;background: #fff;" ><a href="/jiaju_mobile/login" style="width:100%;text-align:center;">个人中心</a></li>
                  </ul> 
              </div>
