...
class HotelWeixingProductController extends Controller {
    ...
    public function index(Request $request) {
        ...
        $Array = DB::table('hotel_weixing_products')->where('is_delete',0)->orderBy('pro_id', 'desc')->get()->toArray();
      ...
      $paginator =new LengthAwarePaginator($item, $totals, $perPage, $current_page, [
        ...
        return view('admin/hotel_weixing_product_list', ['product_list' => $paginator]);
    }
    ...
    public function add(Request $request) {
       ...
       return view('admin/hotel_weixing_product_add', ['category_list' => $category_list,'shop_list'=>$shop_list]);
    }
    ...
    public function insert(Request $request) {
        ...
        if ($request->hasFile('goods_img')) {
            ...
            $store_result = $goods_img->storeAs('/public/images/HotelWeixingProduct', $image_name);
        }
        ...
        if ($request->hasFile('goods_img')) {
            $Product->image = "/storage/images/HotelWeixingProduct/" . $image_name;
        }
    ...
    public function edit(Request $request,$id) {
        ...
        return view('admin/hotel_weixing_product_edit', ['category_list' => $category_list,'product' =>$product ]);
    }
   ...
   //回收站商品列表
    public function trash(Request $request) {
      ...
      $paginator =new LengthAwarePaginator($item, $totals, $perPage, $current_page, [
        ...
        return view('admin/hotel_weixing_product_trash', ['product_list' => $paginator]);
    }
