...
use App\BookingGood;
class BookingGoodController extends Controller
{
    
     public function index(Request $request)
    {
         $BookingGood = new BookingGood;
         $bookinggood_list = $BookingGood::paginate(2);
         
         //print_r($bookinggood_list);
         
         return view('admin/bookinggood_list', ['bookinggood_list' => $bookinggood_list]);
